...
/**
  MENU
  commandlineuser(allCountries,allAirports,allRunways)


  def commandlineuser(Airport : Array[String] , Runways: Array[String] , Country : Array[String]) : Any = {
  ...
  def commandlinequery(Airport : Array[String] , Runways: Array[String] , Country : Array[String]) : Any = { 
    println("Entrez un nom de pays ou code. Ex : 'Andorra' ou 'AD', 'France' ou 'FR' ")
  }
  
  def commandlinereports(Airport : Array[String] , Runways: Array[String] , Country : Array[String]) : Any = { 
